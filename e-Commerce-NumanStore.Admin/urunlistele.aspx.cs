...
namespace admin2
{
    public partial class urunlistele : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            gtablo = urunyonet.tumliste();
            kaysay = gtablo.Rows.Count;
            kacar = 3;

            liste.InnerHtml = "<table class='table table-bordered' width='115 % ' cellspacing='0' border='1'><tr><td>SIRA NO</td><td>Kategoriler</td><td>Marka</td><td>Ürün Adı</td><td>Fiyat</td><td>Para Birimi</td><td>Barkod Kodu</td> <td>Resim</td> <td>Tarih</td> <td>Detay</td> </tr>";
